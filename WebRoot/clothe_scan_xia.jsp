	...
	<div class="row">
    	<div class="col-lg-12">
        	<ul class="nav nav-pills nav-justified">
                ...
                <li class="active"><a href="xia?dataBase=people_information&tableName=clothe_information">夏装</a></li>
   	...
   	<div class="row">
   	 <%   ArrayList<clothe_bean> clother=(ArrayList)request.getAttribute("clother_xia");
   if(clother!=null){
