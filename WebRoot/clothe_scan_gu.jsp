	...
	<div class="row">
    	<div class="col-lg-12">
        	<ul class="nav nav-pills nav-justified">
                ...
                <li class="active"><a href="gu?dataBase=people_information&tableName=clothe_information">古装汉服</a></li>
            </ul>
        </div>
    </div>   
   	<div class="row">
   	 <%   ArrayList<clothe_bean> clother=(ArrayList)request.getAttribute("clother_gu");
   if(clother!=null){
