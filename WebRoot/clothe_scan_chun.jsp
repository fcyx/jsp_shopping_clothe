	...
	<div class="row">
    	<div class="col-lg-12">
        	<ul class="nav nav-pills nav-justified">
                ...
                <li class="active"><a href="chun?dataBase=people_information&tableName=clothe_information">春装</a></li>
   	...
   	<div class="row">
   	 <%   ArrayList<clothe_bean> clother=(ArrayList)request.getAttribute("clother_chun");
   if(clother!=null){
